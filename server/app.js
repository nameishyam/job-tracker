...
Provide actionable advice, next steps, and if applicable, congratulations or motivation. And remember to address the user in "you" or "you have done this, you have done that", "these are my responses to you, these are my advices to you" instead of any third person addressing like "the candidate". Remember not to conclude the response with open ended responses for further conversation. just end them no need for another conversation or another message from the user. Format your response in markdown.`;
